...
export const DashboardContractsEdit = (props: any) => {
  const { userData } = useDashboardUser();

  return (
    <LayoutDashboard title="Contract" bg={props.bg} color={props.color}>
              ...
              >
                <Box>
                  ...
                  <Breadcrumb>
                    ...
                    <BreadcrumbItem>
                      <BreadcrumbLink as={NextLink} href="/dashboard/contracts">
                        Contract
                      </BreadcrumbLink>
                    </BreadcrumbItem>
...
export default DashboardContractsEdit;
