...
const TechnologyGlossaryForm = dynamic<any>(
  () =>
    import('@/components/TechnologyGlossaryForm').then(
      (mod) => mod.TechnologyGlossaryForm,
    ),
  {
    ssr: false,
    loading: () => (
...
export const DashboardPagesServicesPost = (props: any) => {
  const { userData } = useDashboardUser();

  return (
    <LayoutDashboard title="Job Post" bg={props.bg} color={props.color}>
                ...
                <Box>
                  ...
                  <Breadcrumb>
                    ...
                    <BreadcrumbItem>
                      <BreadcrumbLink
                        as={NextLink}
                        href="/dashboard/pages/technology-glossary"
                      >
                        Technology Glossary
                      </BreadcrumbLink>
                    </BreadcrumbItem>
...
export default DashboardPagesServicesPost;
