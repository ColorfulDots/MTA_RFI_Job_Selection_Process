...
const TechnologiesForm = dynamic<any>(
  () =>
    import('@/components/TechnologiesForm').then((mod) => mod.TechnologiesForm),
  {
    ssr: false,
    loading: () => (
      <Stack>
...
export const DashboardPagesTechnologiesPost = (props: any) => {
  const { userData } = useDashboardUser();

  return (
    <LayoutDashboard
      title="Technologies Post"
      bg={props.bg}
      color={props.color}
    >
                ...
                <Box>
                  ...
                  <Breadcrumb>
                    ...
                    <BreadcrumbItem>
                      <BreadcrumbLink
                        as={NextLink}
                        href="/dashboard/pages/technologies"
                      >
                        Technologies
                      </BreadcrumbLink>
                    </BreadcrumbItem>
...
export default DashboardPagesTechnologiesPost;
