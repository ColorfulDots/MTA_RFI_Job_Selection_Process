...
const BlogsForm = dynamic<any>(
  () => import('@/components/index').then((mod) => mod.BlogsForm),
  { ssr: false, loading: () => <Spinner /> },
);

export const DashboardPagesBlogsPost = (props: any) => {
  const { userData } = useDashboardUser();

  return (
    <LayoutDashboard title="Blogs Post" bg={props.bg} color={props.color}>
...
export default DashboardPagesBlogsPost;
