...
export const DashboardPagesAcronymsEdit = (props: any) => {
  const { userData } = useDashboardUser();

  return (
    <LayoutDashboard title="Acronyms Edit" bg={props.bg} color={props.color}>
...
export default DashboardPagesAcronymsEdit;
