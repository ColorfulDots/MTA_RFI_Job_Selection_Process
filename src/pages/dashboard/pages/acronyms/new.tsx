...
const AcronymsForm = dynamic<any>(
  () => import('@/components/index').then((mod) => mod.AcronymsForm),
  { ssr: false, loading: () => <Spinner /> },
);

export const DashboardPagesAcronymsPost = (props: any) => {
  const { userData } = useDashboardUser();

  return (
    <LayoutDashboard title="Acronyms Post" bg={props.bg} color={props.color}>
...
export default DashboardPagesAcronymsPost;
