...
const ClientForm = dynamic<any>(
  () => import('@/components/index').then((mod) => mod.ClientForm),
...
export const DashboardClientsPost = (props: any) => {
  ...
  return (
    <LayoutDashboard title="Client Post" bg={props.bg} color={props.color}>
        ...
        <Flex h="full" id="app-container">
          ...
          <Box bg={'white'} color={'gray.800'} flex="1" p="6">
            ...
            <Box as="section" py="16">
              ...
              >
                <Box>
                  <ClientForm bg={props.bg} color={props.color} />
                </Box>
              </Box>
            </Box>
          </Box>
