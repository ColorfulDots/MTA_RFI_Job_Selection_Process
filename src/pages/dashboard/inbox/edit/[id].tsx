...
const InboxForm = dynamic<any>(
  () => import('@/components/index').then((mod) => mod.InboxForm),
  { ssr: false, loading: () => <Spinner /> },
);

export const DashboardJobsPost = (props: any) => {
  const { userData } = useDashboardUser();

  return (
    <LayoutDashboard title="Job Edit" bg={props.bg} color={props.color}>
              ...
              >
                <Box>
                  ...
                  <Breadcrumb>
                    ...
                    <BreadcrumbItem>
                      <BreadcrumbLink as={NextLink} href="/dashboard/jobs">
                        Jobs
                      </BreadcrumbLink>
                    </BreadcrumbItem>
...
export default DashboardJobsPost;
