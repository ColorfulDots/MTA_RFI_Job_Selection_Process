...
const AccountForm = dynamic<any>(
  () => import('@/components/index').then((mod) => mod.AccountForm),
  { ssr: false, loading: () => <Spinner /> },
);

export const DashboardAgenciesEdit = (props: any) => {
  const { userData } = useDashboardUser();

  return (
    <LayoutDashboard title="Agency" bg={props.bg} color={props.color}>
              ...
              >
                <Box>
                  ...
                  <Breadcrumb>
                    ...
                    <BreadcrumbItem>
                      <BreadcrumbLink as={NextLink} href="/dashboard/agencies">
                        Agency
                      </BreadcrumbLink>
                    </BreadcrumbItem>
...
export default DashboardAgenciesEdit;
