...
const AccountForm = dynamic<any>(
  () => import('@/components/AccountForm').then((mod) => mod.AccountForm),
  {
    ssr: false,
    loading: () => (
      <Stack>
...
export const DashboardAgenciesPost = (props: any) => {
  const { userData } = useDashboardUser();

  return (
    <LayoutDashboard title="Account Post" bg={props.bg} color={props.color}>
        ...
        <Flex h="full" id="app-container">
          ...
          <Box bg={'white'} color={'gray.800'} flex="1" p="6">
            ...
            <Box as="section" py="16">
              ...
              >
                <Box>
                  <AccountForm bg={props.bg} color={props.color} />
                </Box>
              </Box>
            </Box>
          </Box>
...
export default DashboardAgenciesPost;
