...
export const DashboardUserProfileSettings = (props: any) => {
  const { userData } = useDashboardUser();

  return (
    <LayoutDashboard title="My Settings" bg={props.bg} color={props.color}>
...
export default DashboardUserProfileSettings;
