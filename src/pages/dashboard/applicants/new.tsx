...
export const DashboardApplicantsPost = (props: any) => {
  const { userData } = useDashboardUser();

  return (
    <LayoutDashboard title="Applicants Post" bg={props.bg} color={props.color}>
        ...
        <Flex h="full" id="app-container">
          ...
          <Box bg={'white'} color={'gray.800'} flex="1" p="6">
            ...
            <Box as="section" py="16">
              ...
              >
                <Box>
                  <ApplicantsForm bg={props.bg} color={props.color} />
                </Box>
              </Box>
            </Box>
          </Box>
...
export default DashboardApplicantsPost;
