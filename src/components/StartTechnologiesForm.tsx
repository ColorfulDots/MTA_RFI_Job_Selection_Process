...
export interface StartTechnologiesFormProps {}

export const StartTechnologiesForm: React.FC<any> = (props: any) => {
  ...
  const onSubmit = (data: any) => {
    const dataObj = {
      ...data,
      attachment: fileUrl,
      technology: `Technology: ${props.technologiesData?.title}`,
    ...
    add(dataObj)
      .then(() => {
        ...
        //   isClosable: true,
        // });
        router.push(`/technologies/${router.query.slug}/start/success`);
      })
      .catch((errors) => {
        toast({
          title: 'Error!',
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <Box bg={darken(0.035, props.bg.toString())} p={8} rounded={'md'}>
        <Box>
          <Heading size="lg" mb="6">
            {props.technologiesData?.title}
          </Heading>
          {/* <Text>
        ...
        <SimpleGrid columns={[1, 1, 1, 1, 3]} spacing={10} mb={8}>
          <Box>
            <FormControl id="firstName" isInvalid={errors['firstName']}>
              ...
              />
              <FormErrorMessage color={props.color} colorScheme="whiteAlpha">
                <RiErrorWarningLine color={props.color} size={20} />{' '}
                <Text ml={2}>
      ...
      <Box bg={darken(0.035, props.bg.toString())} p={8} rounded={'md'} mt={8}>
        <Heading size="sm" mb="4">
          Project Information
        </Heading>
                  ...
                  <RadioGroup name="technologyRoadmap">
                    <Stack spacing={5} direction="row">
                      <Radio
                        ...
                        bg={darken(0.2, props.bg.toString())}
                        color={props.color}
